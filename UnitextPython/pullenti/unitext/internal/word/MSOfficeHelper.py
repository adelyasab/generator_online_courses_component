...
from UnitextPython.pullenti.unitext.internal.word.CompoundFileSystem import CompoundFileSystem
...
class MSOfficeHelper:
    ...
    def __uni_from_word97(cf : 'CompoundFileSystem') -> 'UnitextDocument':
        from UnitextPython.pullenti.unitext.internal.word.WordDocument import WordDocument
        word_ = WordDocument()
